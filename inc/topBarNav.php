            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link <?= isset($page) && $page == 'facility_available'? "active" : '' ?>" href="./?p=facility_available">Canchas</a></li>
                ...
                <div>
                    ...
                    <div class="d-flex align-items-end">
                      <div class="navbar-nav nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <span><img src="<?= validate_image($_settings->userdata('image_path')) ?>" alt="user_avatar" id="user_avatar" class="img-fluid img-thumbnail rounded-circle border-dark"></span> ¿Qué tal, <?= $_settings->userdata('email') ?>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                          <a class="dropdown-item" href="./?p=booking_list">Mis reservas</a>
                  ...
                  <?php else: ?>
                    <a href="./login.php" class="text-reset text-decoration-none mx-2"><b>Entrar</b></a> | 
                    <a href="./register.php" class="text-reset text-decoration-none mx-2"><b>Registrarse</b></a> | 
