...
<div class="container-fluid">
    <fieldset class="border-bottom">
        <legend class="h5 text-muted"> Detalles de Canchas</legend>
        <dl>
            <dt class="">Codigo de Cancha</dt>
    ...
    <fieldset class="bor">
        <legend class="h5 text-muted"> Detalles de Reserva</legend>
        <dl>
            <dt class="">Codigo de Ref.</dt>
                ...
                <?php 
                    switch($status){
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            echo "<span class='badge badge-warning bg-gradient-success px-3 rounded-pill'>Completado</span>";
                            break;
                        case 3:
    ...
    <div class="text-right">
        ...
        <button class="btn btn-danger btn-flat bg-gradient-danger" type="button" id="cancel_booking">Cancelar Reserva</button>
        <?php endif; ?>
