    ...
    <div class="container">
        <div class="card card-outline card-dark shadow rounded-0">
            <div class="card-header">
                <h4 class="card-title"><b>Administración de Cuentas</b></h4>
            </div>
            <div class="card-body">
                    ...
                    <form id="register-frm" action="" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <input type="text" name="firstname" id="firstname" placeholder="Ingresar Nombre" autofocus class="form-control form-control-sm form-control-border" value="<?= isset($firstname) ? $firstname : "" ?>" required>
                            </div>
                            <div class="form-group col-md-6">
                                <input type="text" name="lastname" id="lastname" placeholder="Ingresar Apellido" class="form-control form-control-sm form-control-border" required value="<?= isset($lastname) ? $lastname : "" ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                <input type="text" name="contact" id="contact" placeholder="Ingresar Celular" class="form-control form-control-sm form-control-border" required value="<?= isset($contact) ? $contact : "" ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-12">
                            <small class="ml-3">Dirección</small>
                            <textarea name="address" id="address" rows="3" class="form-control form-control-sm rounded-0" placeholder="Cuadra 6 Lot 23, Aqui Subd., Aqui Ciudad, En cualquiera lugar, 2306"><?= isset($address) ? $address : "" ?></textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12"><small class="text-muted"><em>Complete los campos de contraseña anteriores solo si desea actualizar su contraseña.</em></small></div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <div class="input-group">
                        ...
                        <div class="row align-items-center">
                            ...
                            <!-- /.col -->
                            <div class="col-4">
                            <button type="submit" class="btn btn-primary btn-sm btn-flat btn-block">Actualizar Detalles</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
