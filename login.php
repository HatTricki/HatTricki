...
<?php $page = isset($_GET['page']) ? $_GET['page'] : 'home';  ?>
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="./" class="h1 text-decoration-none"><b>Ingresar</b></a>
    </div>
    <div class="card-body">
      ...
      <form id="clogin-frm" action="" method="post">
        ...
        <div class="row align-items-center">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-sm btn-flat btn-block">Ingresar</button>
          </div>
          <!-- /.col -->
        </div>
        <div class="row">
            <div class="col-12 text-center">
             <a href="<?php echo base_url.'register.php' ?>">Crear cuenta</a>
            </div>
        </div>
      </form>
      <!-- /.social-auth-links -->
