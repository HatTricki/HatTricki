...
<div class="card card-outline card-info rounded-0">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Editar ": "Crear " ?> Cancha</h3>
	</div>
	<div class="card-body">
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="facility-form">Guardar</button>
		<a class="btn btn-flat btn-default" href="?page=facilities">Cancelar</a>
	</div>
</div>
<script>
