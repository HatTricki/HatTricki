...
<div class="content py-3">
    <div class="card card-outline rounded-0 card-primary shadow">
        <div class="card-header">
            <h4 class="card-title">Ver Cancha</h4>
            <div class="card-tools">
                <a class="btn btn-primary btn-sm btn-flat" href="./?page=facilities/manage_facility&id=<?= isset($id) ? $id : "" ?>"><i class="fa fa-edit"></i> Editar</a>
                <a class="btn btn-danger btn-sm btn-flat" href="javascript:void(0)>" id="delete_data"><i class="fa fa-trash"></i> Eliminar</a>
                <a class="btn btn-default border btn-sm btn-flat" href="./?page=facilities"><i class="fa fa-angle-left"></i> Atras</a>
            </div>
        </div>
        <div class="card-body">
            <div class="container">
