...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Tus canchas</h3>
		<div class="card-tools">
			<a href="?page=facilities/manage_facility" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Crear</a>
		</div>
	</div>
	<div class="card-body">
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
                                    <a class="dropdown-item" href="?page=facilities/view_facility&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> Ver</a>
				                    <div class="dropdown-divider"></div>
				                    <a class="dropdown-item" href="?page=facilities/manage_facility&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Editar</a>
				                    <div class="dropdown-divider"></div>
...
<script>
	...
	function delete_facility($id){
		...
		$.ajax({
			...
			error:err=>{
				console.log(err)
				alert_toast("No se puede realizar esta acción.",'error');
				end_loader();
			},
