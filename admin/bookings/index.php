<div class="card card-outline card-primary shadow rounded-0">
    <div class="card-header">
        <h3 class="card-title"><b>Reservas</b></h3>
    </div>
    <div class="card-body">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-flat btn-sm btn-default border view_data" href="javascript:void(0)" data-id="<?= $row['id'] ?>"><i class="fa fa-eye"></i> Ver</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
