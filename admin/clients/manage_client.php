...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="client-form">
			...
			<div class="form-group">
                ...
                <option <?php echo isset($gender) && $gender == 'Male' ? 'selected' : '' ?>>Hombre</option>
                <option <?php echo isset($gender) && $gender == 'Female' ? 'selected' : '' ?>>Mujer</option>
                </select>
			</div>
            <div class="form-group">
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=client">Cancelar</a>
	</div>
</div>
<script>
