    ...
    <div class="container">
        <div class="card card-outline card-primary shadow rounded-0">
            <div class="card-header">
                <h4 class="card-title">Mi Lista de Reservas</h4>
            </div>
            <div class="card-body">
                <table class="table table-striped table-bordered">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Codigo de Ref</th>
                            <th class="text-center">Canchas</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button type="button" class="btn btn-flat btn-light border btn-sm view_data" data-id="<?= $row['id'] ?>">Ver</button>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
